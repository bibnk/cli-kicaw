...
/*
   ...
   в–€в–€в•‘  в–€в–€в•‘в–€в–€в•”в•ђв•ђв–€в–€в•—в–€в–€в•”в•ђв•ђв•ђв•ђв•ќв–€в–€в•‘  в–€в–€в•‘
   в–€в–€в–€в–€в–€в–€в–€в•‘в–€в–€в–€в–€в–€в–€в–€в•‘в–€в–€в–€в–€в–€в–€в–€в•—в–€в–€в–€в–€в–€в–€в–€в•‘
   в–€в–€в•”в•ђв•ђв–€в–€в•‘в–€в–€в•”в•ђв•ђв–€в–€в•‘в•љв•ђв•ђв•ђв•ђв–€в–€в•‘в–€в–€в•”в•ђв•ђв–€в–€в•‘
   в–€в–€в•‘  в–€в–€в•‘в–€в–€в•‘  в–€в–€в•‘в–€в–€в–€в–€в–€в–€в–€в•‘в–€в–€в•‘  в–€в–€в•‘
   в•љв•ђв•ќ  в•љв•ђв•ќв•љв•ђв•ќ  в•љв•ђв•ќв•љв•ђв•ђв•ђв•ђв•ђв•ђв•ќв•љв•ђв•ќ  в•љв•ђв•ќ

   The first mined post-quantum token with a self-hook вЂ”
   the ERC20 token contract IS its own Uniswap V4 hook.
   One address, one bytecode: the token, the hook, and
   the PoW miner are the same contract.

   https://hash256.org/
   https://x.com/hash256dotorg
*/
...
contract Hash is ERC20, IHooks, ReentrancyGuard {
    ...
    /// @notice Per-tx unit cap. 5 units Г— 1,000 HASH = 5,000 HASH per call
    ///         (costs 0.05 ETH). No per-wallet accumulation вЂ” a buyer can
    ///         submit multiple txs back-to-back to clear more, but each
    ///         call is bounded so a single mempool slot can't sweep the
    ///         entire genesis allocation in one shot.
    ...
    function mintGenesis(uint256 units) external payable nonReentrant {
        ...
        uint256 hashAmount = units * GENESIS_UNIT;
        uint256 cost       = units * GENESIS_PRICE;
        if (msg.value < cost)                         revert InsufficientPayment();
        if (genesisMinted + hashAmount > GENESIS_CAP) revert GenesisSoldOut();

        genesisMinted    += hashAmount;
        ...
        _mint(msg.sender, hashAmount);
        emit GenesisMint(msg.sender, cost, hashAmount);
    }
    ...
    function _seedBody() internal {
        ...
        uint256 hashLP = genesisMinted;

        _mint(address(this), hashLP + MINING_SUPPLY);
        ...
        uint160 sqrtPriceX96 = _sqrtPriceX96FromAmounts(eth, hashLP);
        ...
        emit LiquidityAdded(eth, hashLP, liquidity);
        emit PoolSeeded(eth, hashLP, sqrtPriceX96);
    }
